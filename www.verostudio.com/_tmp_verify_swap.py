...
def main() -> None:
    with sync_playwright() as playwright:
        ...
        result = page.evaluate(
          ...
          return {
            slide1UsesSlide2: slide1.every((el) => (el.currentSrc || el.src || '').includes('/images/slide-2.jpg')),
            slide2UsesSlide1: slide2.every((el) => (el.currentSrc || el.src || '').includes('/images/slide-1.jpg')),
        ...
        ok = (
            not malformed
            and result.get("slide1UsesSlide2")
            and result.get("slide2UsesSlide1")
